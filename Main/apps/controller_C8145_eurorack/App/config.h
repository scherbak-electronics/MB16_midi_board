 ...
 * Port B config
 *///                                  76543210
#define SYSTEM_PORT_CFG_DDRB         0b11100000 // Direction: 0 = input, 1 = output
...
#define controllerGatesPortOut              PORTB
#define CONTROLLER_GATES_0_CFG_PORT_OUT_BIT 5
#define CONTROLLER_GATES_1_CFG_PORT_OUT_BIT 6
#define CONTROLLER_GATES_2_CFG_PORT_OUT_BIT 7